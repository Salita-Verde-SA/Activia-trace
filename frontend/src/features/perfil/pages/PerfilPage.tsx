...
export function PerfilPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    actualizarPerfil.mutate(
      { nombre, apellido, cbu: cbu || null, alias_cbu: aliasCbu || null },
      {
      ...
      <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl shadow-sm p-6 space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <ReadOnlyField label="DNI" value={perfil?.dni ?? '—'} />
            <ReadOnlyField label="CUIL" value={perfil?.cuil ?? '—'} />
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-white/70 mb-1">CBU</label>
              <input
                type="text"
                value={cbu}
            ...
            <div>
              <label className="block text-sm font-medium text-white/70 mb-1">Alias CBU</label>
              <input
                type="text"
                value={aliasCbu}
