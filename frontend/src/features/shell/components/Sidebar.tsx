...
export const Sidebar = ({ isOpen, closeSidebar }: { isOpen: boolean, closeSidebar: () => void }) => {
  ...
  const menuItems = [
    ...
    { name: 'Mis Clases', path: '/alumno/clases', icon: 'event', roles: ['ALUMNO'] },
    { name: 'Calificaciones', path: '/calificaciones', icon: 'grade', roles: ['PROFESOR', 'TUTOR', 'COORDINADOR', 'ADMIN'] },
    { name: 'Mensajes', path: '/mensajes', icon: 'forum', roles: ['PROFESOR', 'TUTOR', 'COORDINADOR', 'ADMIN'] },
    { name: 'Encuentros', path: '/encuentros', icon: 'event', roles: ['COORDINADOR', 'ADMIN'] },
    { name: 'Mis Encuentros', path: '/mis-encuentros', icon: 'event', roles: ['PROFESOR', 'TUTOR'] },
    { name: 'Mis Guardias', path: '/guardias', icon: 'security', roles: ['TUTOR'] },
    { name: 'Guardias', path: '/admin/guardias', icon: 'security', roles: ['COORDINADOR', 'ADMIN'] },
    ...
    { name: 'Comunicaciones', path: '/comunicaciones', icon: 'mail', roles: ['PROFESOR', 'TUTOR'] },
    ...
    { name: 'Materias y Equipos', path: '/admin/materias', icon: 'menu_book', roles: ['ADMIN'] },
    { name: 'Programas y Fechas', path: '/admin/programas', icon: 'menu_book', roles: ['COORDINADOR', 'ADMIN'] },
    ...
    { name: 'Mi Perfil', path: '/perfil', icon: 'manage_accounts', roles: ['ALUMNO', 'PROFESOR', 'TUTOR', 'COORDINADOR', 'ADMIN', 'FINANZAS'] },
