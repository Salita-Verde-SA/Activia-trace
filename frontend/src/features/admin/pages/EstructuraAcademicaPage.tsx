...
export function EstructuraAcademicaPage() {
  const [activeTab, setActiveTab] = useState<'carreras' | 'cohortes'>('carreras');

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-serif text-white/90">Estructura Académica</h1>
        <p className="mt-1 text-sm text-white/70">Gestión del catálogo de carreras y cohortes del tenant.</p>
      </div>
