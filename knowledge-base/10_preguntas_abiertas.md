...
| PA-22 | El mapeo de claves a materias es dinámico y configurable por el ADMIN de cada tenant, agregando un atributo opcional `clave_plus` a la entidad `Materia`. | [04_modelo_de_datos.md](04_modelo_de_datos.md) |
| PA-23 | El SalarioPlus NO es acumulativo por cantidad de comisiones de la misma familia. Se suma una sola vez por clave para cada rol, actuando como un adicional fijo por experticia. | [05_reglas_de_negocio.md](05_reglas_de_negocio.md) |
