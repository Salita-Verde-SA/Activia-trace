...
// Runner executes a list of steps for a given stage, emitting progress events.
type Runner struct {
	FailurePolicy FailurePolicy
	OnProgress    ProgressFunc
}

// Run executes steps in order for the given stage.
// Under StopOnError it halts at the first failure; under ContinueOnError it
