...
- Reading 4+ files to "understand" the codebase inline → delegate to subagent
- Writing a feature across multiple files inline → delegate to subagent
- Running tests or builds inline → delegate to subagent
...
3. Use recovered context to brief subagents accurately
