...
El sistema DEBE proveer endpoints CRUD protegidos bajo `/api/asignaciones` (usando el permiso `equipos:asignar`). Además, la asignación PUEDE tener un `responsable_id` para definir relaciones jerárquicas (por ejemplo, a quién reporta).
